 ...
 */
public final class FlushByteBuffersIndexOutput extends IndexOutput {
  private final Consumer<FlushByteBuffersDataOutput> onClose;
  
  private final Checksum checksum;
  private long lastChecksumPosition;
  private long lastChecksum;

  private FlushByteBuffersDataOutput delegate;

  public FlushByteBuffersIndexOutput(FlushByteBuffersDataOutput delegate, String resourceDescription, String name) {
    this(delegate, resourceDescription, name, new CRC32(), null);
  }

  public FlushByteBuffersIndexOutput(FlushByteBuffersDataOutput delegate, String resourceDescription, String name, 
      Checksum checksum,
      Consumer<FlushByteBuffersDataOutput> onClose) {
  ...
  public void close() throws IOException {
    ...
    FlushByteBuffersDataOutput local = delegate;
    delegate = null;
